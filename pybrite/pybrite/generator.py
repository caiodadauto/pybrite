...
def graph_batch_generator(n_batch, interval_node, interval_m=(2, 2), random_state=None, input_fields=None, target_fields=None, global_field=None):
    ...
    while True:
        ...
        for _ in range(n_batch):
            ...
            input_graph, target_graph = graph_to_input_target(di_graph, target_node, input_fields=input_fields, target_fields=target_fields, global_field=global_field)
